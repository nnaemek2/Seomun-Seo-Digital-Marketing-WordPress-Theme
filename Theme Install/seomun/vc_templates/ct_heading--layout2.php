...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="ct-heading layout2 <?php echo esc_attr( $align_lg.' '.$align_md.' '.$align_sm.' '.$align_xs.' '.$animation_classes ); ?>">
    ...
    <?php if(!empty($description)) : ?>
        <div class="ct-text-below" <?php if(!empty($des_color)) : ?>style="color:<?php echo esc_attr($des_color); ?>"<?php endif; ?>><?php echo wp_kses_post( $description ); ?></div>
    <?php endif; ?>
</div>