...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-portfolio-maronry <?php echo esc_attr($el_parallax_class); ?>" <?php echo esc_attr($parallax_speed); ?>>
            ...
            foreach ($posts as $key => $post) {
                ...
                ?>
                    <div class="<?php echo esc_attr($item_class . ' ' . $filter_class); ?>">
                        <div class="grid-item-inner <?php echo esc_attr( $show_holder );?>">
