...
extract(shortcode_atts(array(
    'api' => 'AIzaSyDP8vfj0x6ho6EzaCEcv2srz16FVgDwIXg',
...
$link = vc_build_link($map_link_butotn);
$a_href = '';
$a_target = '';
...
<div class="ct-google-map">
    <?php if($map_box == 'yes') : ?>
        <div class="ct-map-box">
            <div class="ct-map-box-address"><?php echo esc_attr($address); ?></div>
            <img src="<?php echo esc_url($map_image_url); ?>" />
            <div class="ct-map-box-meta">
                <a href="tel:<?php echo esc_attr($map_phone); ?>"><?php echo esc_attr($map_phone); ?></a><br/>
                <a href="mailto:<?php echo esc_attr($map_mail); ?>"><?php echo esc_attr($map_mail); ?></a><br/>
                <a class="btn" href="<?php echo esc_url($a_href);?>" target="<?php  echo esc_attr($a_target); ?>"><?php echo esc_attr($map_text_butotn); ?></a>
            </div>
        </div>
    <?php endif; ?>
