...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-portfolio-layout1 <?php echo esc_attr($el_parallax_class); ?>" <?php echo esc_attr($parallax_speed); ?>>
                    ...
                    <div class="<?php echo esc_attr($item_class . ' ' . $filter_class); ?>">
                        <div class="grid-item-inner">
                            <div class="item-featured">
                                 <a class="overlay-gradient <?php echo esc_attr( $media_class ); ?>" href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
