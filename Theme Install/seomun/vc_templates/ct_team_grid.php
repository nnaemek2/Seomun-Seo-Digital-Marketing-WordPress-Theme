...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-team-layout1">
    ...
    <div class="ct-grid-inner ct-grid-masonry row" data-gutter="15">
        ...
        <?php foreach ($team_content_list as $key => $value) {
            ...
            $content_team = isset($value['content_team']) ? $value['content_team'] : '';
                        ...
                        <div class="team-holder-inner">
                            ...
                            <?php if( $content_team ):?>
                                <div class="team-content">
                                    <?php echo esc_attr($content_team); ?>  
                                </div>
                            <?php endif;?>
