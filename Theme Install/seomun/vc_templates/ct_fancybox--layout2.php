...
?>
<div class="ct-fancybox-layout2 <?php echo esc_attr($animation_classes); ?>">
	<div class="ct-fancybox-inner" <?php if(!empty($fc_margin_botton)) : ?> style="margin-bottom:  <?php echo esc_attr( $fc_margin_botton );?>"<?php endif;?>>
