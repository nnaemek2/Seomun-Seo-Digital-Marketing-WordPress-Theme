...
?>
<div class="ct-fancybox-layout5 <?php echo esc_attr( $animation_classes.' '.$fc_primary_color); ?>" style="margin-bottom: <?php echo esc_attr( $fc_margin_botton );?>">
        ...
        <div class="ct-fancybox-holder">
            ...
            <?php if(!empty($a_href)) : ?>
                <div class="ct-fancybox-more">
                    <a href="<?php echo esc_url($a_href);?>" target="<?php  echo esc_attr($a_target); ?>"><i class="fac fac-arrow-right"></i></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
