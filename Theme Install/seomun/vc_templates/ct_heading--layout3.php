...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="ct-heading layout3 <?php echo esc_attr( $align_lg.' '.$align_md.' '.$align_sm.' '.$align_xs.' '.$animation_classes ); ?>">
    ...
    <div class="ct-inline-css"  data-css="
        ...
        <?php if( !empty($line_color)) : ?>
            #<?php echo esc_attr($atts['html_id']);?>.ct-heading .ct-h-line span,
            #<?php echo esc_attr($atts['html_id']);?>.ct-heading .ct-h-line span.h-center:before {
    ...
    <?php endif; ?>
    <div class="ct-h-line <?php echo esc_attr( $line_display );?>">
