...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-grid-team-layout3">

    <div class="ct-grid-inner <?php echo esc_attr( $item_gap_team );?> ct-grid-masonry row" data-gutter="15">
        ...
        <?php foreach ($team_content_list as $key => $value) {
            ...
            $img_size = isset($value['img_size']) ? $value['img_size'] : '600x654';
