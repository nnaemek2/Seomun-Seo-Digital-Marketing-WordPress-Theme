...
<header id="masthead" class="header-main">
    <div id="header-wrap" class="header-layout1 fixed-height <?php if($sticky_on == 1) { echo 'is-sticky'; } else { echo 'no-sticky'; } ?>">
                    ...
                    <div class="header-navigation">
                        <nav class="main-navigation">
                            <div class="main-navigation-inner">
                                ...
                                <?php if(!empty($topbar_phone)) : ?>
                                    <a class="btn-mobile btn btn-secondary" href="tel:<?php echo esc_attr( $phone_result ); ?>"><i class="fa fa-phone"></i><span><?php echo esc_attr( $topbar_phone ); ?></span></a>
                                <?php endif; ?>
                            </div>
                        </nav>
                        ...
                        <?php if(!empty($topbar_phone)) : ?>
                            <div class="header-btn-phone">
                                <a href="tel:<?php echo esc_attr( $phone_result ); ?>"><i class="fa fa-phone"></i><span><?php echo esc_attr( $topbar_phone ); ?></span></a>
                            </div>
                        <?php endif; ?>
