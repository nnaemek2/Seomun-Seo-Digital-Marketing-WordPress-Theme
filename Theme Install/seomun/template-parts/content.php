...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-hentry archive clearfix'); ?>>
    <?php if (has_post_format('gallery')) : ?>
        <div class="entry-featured entry-gallery">
            ...
            $gallery_list = explode(',', seomun_get_post_format_value('archive-post', ''));
    ...
    <?php else :
        if (has_post_thumbnail()) {
            echo '<div class="entry-featured"><div class="post-image">'; ?>
                <a href="<?php echo esc_url( get_permalink()); ?>"><?php the_post_thumbnail('archive-post'); ?></a>
            <?php echo '</div></div>';
        } ?>
    <?php endif; ?>
