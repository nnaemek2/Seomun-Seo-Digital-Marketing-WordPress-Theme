...
vc_map(
    array(
        'name'     => esc_html__('Blog Grid', 'seomun'),
        'base'     => 'ct_blog_grid',
        'class'    => 'ct-icon-element',
        'description' => esc_html__( 'Posts in masonry grid', 'seomun' ),
        ...
        'params'   => array(
            ...
            array(
                'type' => 'textfield',
                'heading' => __( 'Image size', 'seomun' ),
                'param_name' => 'img_size',
                'value' => '',
                'description' => __( 'Enter image size (Example: "thumbnail", "medium", "large", "full" or other sizes defined by theme). Alternatively enter size in pixels (Example: 200x100 (Width x Height)). Enter multiple sizes (Example: 100x100,200x200,300x300)).', 'seomun' ),
