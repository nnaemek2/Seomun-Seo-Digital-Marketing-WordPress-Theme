...
vc_map(
    array(
        'name'     => esc_html__('Portfolio Grid', 'seomun'),
        ...
        'params'   => array(
            ...
            array(
                'type' => 'textarea',
                'heading' => esc_html__( 'Header Content', 'seomun' ),
            ...
            array(
                'type' => 'textfield',
                'heading' => esc_html__('Filter Margin bottom', 'seomun'),
                'param_name' => 'ft_margin_bottom',
...
class WPBakeryShortCode_ct_portfolio_grid extends CmsShortCode
{
    ...
    {
        $html_id = cmsHtmlID('ct-grid-portfolio');
