...
class Newsletter_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'newsletter_widget',
            esc_html__('* Newsletter', 'seomun'),
            array('description' => esc_html__('Newsletter Widget', 'seomun'),)
        );
    }
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('introduction')); ?>"><?php esc_html_e( 'Introduction', 'seomun' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('email_label')); ?>"><?php esc_html_e( 'Email Label', 'seomun' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('button_label')); ?>"><?php esc_html_e( 'Button Label', 'seomun' ); ?></label>
