...
class GetInTouch_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'getintouch_widget',
            esc_html__('* Get In Touch', 'seomun'),
            array('description' => esc_html__('Get In Touch Widget', 'seomun'),)
        );
    }
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('address_text')); ?>"><?php esc_html_e( 'Address', 'seomun' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('email_text')); ?>"><?php esc_html_e( 'Email Text', 'seomun' ); ?></label>
        ...
        <p><label for="<?php echo esc_url($this->get_field_id('phone_text')); ?>"><?php esc_html_e( 'Phone', 'seomun' ); ?></label>
