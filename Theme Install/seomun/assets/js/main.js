;(function ($) {
    ...
    $(window).on('load', function () {
        ...
        seomun_col_offset();
        seomun_header_sticky();
        seomun_scroll_to_top();
        seomun_quantity_icon();
    });
    ...
    $(document).ready(function () {
        ...
        /* Same Height */
        $('.ct-blog-carousel-layout2 .ct-carousel-item').matchHeight();
        $('.vc_row .ct-banner-content').matchHeight();
        $('.vc_row .col-same-height').matchHeight();
        
        $('.vc_row .ct-fancybox-layout4 .ct-fancybox-inner').matchHeight();
        $('.vc_row .ct-fancybox-layout2 .ct-fancybox-inner').matchHeight();
        $('.vc_row .ct-fancybox-layout5').matchHeight();

        $('.vc_row .ct-fancybox-layout6').matchHeight();

        $('.ct-related-post .grid-item-inner').matchHeight();
        $('.ct-related-post .grid-item-inner item-holder').matchHeight();
    ...
    /* =================
     Column Absolute
     =================== */
    function seomun_col_offset() {
        var w_vc_row_lg = ($('#content').width() - 1140) / 2;
        var w_vc_row_sm = ($('#content').width() - 1300) / 2;
        ...
        if (window_width > 1330) {
            $('.col-offset-left-sm > .vc_column-inner').css('padding-left', w_vc_row_sm + 'px');
            $('.col-offset-right-sm > .vc_column-inner').css('padding-right', w_vc_row_sm + 'px');
        }
    }

    function seomun_header_sticky() {
